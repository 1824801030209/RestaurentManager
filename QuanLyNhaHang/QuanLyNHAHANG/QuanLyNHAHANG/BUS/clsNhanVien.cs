...
namespace QuanLyNHAHANG.BUS
{
    class clsNhanVien
    {
        ...
        public void InsertNhanVien(SqlConnection conn)
        {
            ...
            BUS.Until.ExecuteNonQuery(conn, "sp_InsertNhanVien", par, value);
        }
        ...
        public DataTable TimKiemTheoTenNV(SqlConnection conn, string TenNV)
        {
            ...
            return BUS.Until.FillData(conn, "sp_TimKiemTheoTenNV", par, value);
        }
