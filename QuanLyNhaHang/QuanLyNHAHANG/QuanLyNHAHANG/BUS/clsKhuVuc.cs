...
namespace QuanLyNHAHANG.BUS
{
    class clsKhuVuc :IKhuVuc
    {
        ...
        public void InsertKhuVuc(SqlConnection conn)
        {
            ...
            BUS.Until.ExecuteNonQuery(conn, "sp_ThemKhuVuc", par, value);
        }
