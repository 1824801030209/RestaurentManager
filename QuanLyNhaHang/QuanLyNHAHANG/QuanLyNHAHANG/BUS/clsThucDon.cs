...
namespace QuanLyNHAHANG.BUS
{
    class clsThucDon : IThucDon
    {
        ...
        public void InsertThucDon(SqlConnection conn)
        {
            ...
            BUS.Until.ExecuteNonQuery(conn, "sp_ThemThucDon", par, value);
        }
        public void UpdateThucDon(SqlConnection conn, string DK)
        {
            ...
            BUS.Until.ExecuteNonQuery(conn, "sp_UpdateThucDon", par, value);
        }
        public DataTable TimKiemMonAn(SqlConnection conn, string Text)
        {
            ...
            return BUS.Until.FillData(conn, "sp_TimKiemMonAn", par, value);
        }
        public void DeleteThucDon(SqlConnection conn, string Ten, int ID)
        {
            ...
            BUS.Until.ExecuteNonQuery(conn, "sp_XoaThucDon", par, value);
        }
    }
}
