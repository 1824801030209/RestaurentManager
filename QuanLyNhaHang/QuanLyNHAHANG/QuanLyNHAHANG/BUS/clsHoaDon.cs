...
namespace QuanLyNHAHANG.BUS
{
    class clsHoaDon
    {
        ...
        public void UpdateHoaDon(SqlConnection conn)
        {
            ...
            Until.ExecuteReader(conn, "sp_UpdateHoaDon", par, value);
        }
        ...
        public void XoaHoaDonTheoTen(SqlConnection conn, int STT, string TenMon)
        {
            ...
            BUS.Until.ExecuteNonQuery(conn, "sp_XoaHoaDonTheoTen", par, value);
        }
    }
}
