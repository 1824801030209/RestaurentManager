...
namespace QuanLyNHAHANG.BUS
{
    class clsDanhMuc :IDanhMuc
    {
        ...
        public void InsertDanhMuc(SqlConnection conn)
        {
            ...
            BUS.Until.ExecuteNonQuery(conn, "sp_ThemDanhMuc", par, value);
        }
