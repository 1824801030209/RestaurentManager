...
namespace QuanLyNHAHANG.BUS
{
    class clsBan :IBan
    {
        ...
        public void CapNhatTrangThaiBan(SqlConnection conn, string TT, float TongCong, string TenBan)
        {
            ...
            BUS.Until.ExecuteNonQuery(conn, "sp_CapNhatTrangThaiBan", par, value);
        }
        ...
        public void InsertBan(SqlConnection conn, string TenBan, int iD)
        {
            ...
            BUS.Until.ExecuteNonQuery(conn, "sp_ThemBan", par, value);
        }
